...
export const CORE_TENANT_EXPORT_POLICY: TenantExportPolicyRegistry = {
  ...
  "file_egress_events": tablePolicy("org_id", {"included":["id","org_id","device_id","source_event_id","egress_type","occurred_at","created_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["details"]}),
  "file_egress_policies": tablePolicy("org_id", {"included":["id","org_id","partner_id","name","enabled","watch_removable","watch_network_shares","watch_uploads","min_file_size_bytes","is_active","created_by","created_at","updated_at"],"reviewedIncluded":[],"excludedSensitive":[],"excludedOpen":["upload_process_watchlist","ignore_globs"]}),
