...
export const reportTypeSchema = z.enum([
  ...
  // #3198 W01. PSA business reports — enum labels only this wave. A
  // partner-owned definition of these can be created and scheduled, but every
  // generate answers unsupported_report_scope until W02 registers generators.
