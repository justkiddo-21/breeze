...
Two of the three pillars have a console UI today:
...
<Aside type="caution">
  Baselines and change events (create/scan a baseline, view or acknowledge change events) have no console UI yet -- everything under "Network Baselines" and "Change Detection" below is done through the API.
</Aside>
