...
2. Review the nine required permissions shown on the card, then choose **Connect**.
...
6. Confirm the card shows **Active**, the expected tenant name/GUID, manifest version 2, and no missing or unexpected permissions.
</Steps>
