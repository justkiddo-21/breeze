...
<Aside type="tip">
  Devices in an active maintenance window with automation suppression enabled are automatically excluded from a policy-managed automation's run, for both schedule and event triggers. This does not apply to standalone automations created directly on the Automations page. See [Automation and Patching Suppression](/features/maintenance-windows/#automation-and-patching-suppression) for the full behavior.
</Aside>
