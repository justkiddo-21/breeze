...
<Aside type="caution">
  **Test connection** does not currently make a live request to the provider -- it always reports success. Use it to confirm the form accepted your input, not to verify the endpoint, key, or service ID is actually correct and reachable.
</Aside>
...
4. Click **Test connection** — the status badge turns **Active** (see the caution above: this does not actually check reachability yet).
