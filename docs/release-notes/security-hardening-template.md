...
- W07 removed the expired SSO refresh-token JSON compatibility response. SSO exchange now installs refresh authority only through the HttpOnly cookie; external clients must use the cookie-based handoff.
